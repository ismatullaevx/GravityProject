        ...
        <div>
            ...
            <div className=' flex justify-between'>
                <div className='text-[#fff] flex flex-col gap-4'>
                    ...
                    <h1 className='text-[20px] font-[900'>Accelerate your token’s journey by <br/> boosting its
                        liquidity</h1>
                    <h1>We invest in building long-term, <br/> sustainable relationships and support our <br/> projects
                        in their growth journey with our <br/> services, industry expertise and network.</h1>
                    <a
                        href="#contact"
